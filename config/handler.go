...
func InitConfig(cfgFile string) {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".blowfish" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".blowfish")
		viper.SetConfigType("yaml")
	}

	viper.SetEnvPrefix("blowfish")
	viper.AutomaticEnv()
...
func SetDefault(name string) error {
	...
	return NewArgumentError("system name", name)
}
